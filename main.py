...
bot_token = os.environ.get("TOKEN","7074149481:AAHUfZAGM1gf9gniE8Fbn_5tZJ13RPR8RQY") # Botunuzun Tokenini Girin.
sahib = os.environ.get("sahib", "espKaizen") # Sahiplik Hesabin Kullanıcı Adını Girin .
BOT_ID = int(os.environ.get("BOT_ID", "7074149481")) # Botunuzun İd'si ( Tokenin Başındaki Rakamları ) Girin .
DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://Ozgur_851:ozgur851@cluster0.qqcbp3x.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # MongoDB veritabanınızın url'si.
BOT_USERNAME = os.environ.get("BOT_USERNAME","Beyzabot") # Botunuzun kullanıcı adı.
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL"," 

-1002140878451")) # Botunuzun eylemleri kaydedeceği kayıt grubunun id'si.
GROUP_SUPPORT = os.environ.get("GROUP_SUPPORT", "espKaizen") # Botunuzdan yasaklanan kullanıcıların itiraz işlemleri için başvuracağı grup, kanal veya kullanıcı. Boş bırakırsanız otomatik olarak OWNER_ID kimliğine yönlendirecektir.
...
OWNER_ID = int(os.environ.get("OWNER_ID","6157974535")) # Sahip hesabın id'si
